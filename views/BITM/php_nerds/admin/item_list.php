...
$pages = ceil($all_items_number/$itemsPerPage);
$someData = $objectAddItem->item_list_pagination($page, $itemsPerPage);
...
<nav class="navbar navbar-inverse navbar-fixed-top">
    <div class="container-fluid">
        ...
        <div id="navbar" class="navbar-collapse collapse">
            ...
            <form class="navbar-form navbar-right" name="search_form" id="search_form" action="" method="post">
...
<div class="table-responsive" id="items_table">
            ...
            <div class="table-responsive">
                <table class="table table-striped">
                   ...
                   // $serial = 1;
                    $background_color = "";
                    //traversing $someData for pagination//
...
<div align="left" class="container">
    <ul class="pagination">
        ...
        if($page>$pages) Utility::redirect("item_list.php?Page=$pages");
        if($page>1)  echo "<li><a href='item_list.php?Page=$pageMinusOne'>" . "Previous" . "</a></li>";
        ...
        if($page<$pages) echo "<li><a href='item_list.php?Page=$pagePlusOne'>" . "Next" . "</a></li>";
